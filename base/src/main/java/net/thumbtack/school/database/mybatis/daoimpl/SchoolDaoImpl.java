...
public class SchoolDaoImpl extends DaoImplBase implements SchoolDao {
    ...
    public School getById(int id) {
        LOGGER.debug("DAO get School byiD {}", id);
        try (SqlSession sqlSession = getSession()) {
    ...
    public List<School> getAllUsingJoin() {
        ...
        try (SqlSession sqlSession = getSession()) {
            ...
            LOGGER.info("Can't get all using Join {}", ex);
            throw ex;
        }
    }
    ...
    public void update(School school) {
        LOGGER.debug("DAO update school");
        try (SqlSession sqlSession = getSession()) {
            try {
    ...
    public void delete(School school) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                getSchoolMapper(sqlSession).deleteSchool(school);
            } catch (RuntimeException ex) {
